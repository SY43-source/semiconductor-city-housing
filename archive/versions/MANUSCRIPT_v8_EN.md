<!-- v8 EN (2026-07-31): English edition of MANUSCRIPT_v8.md. Adds the housing-access (affordability) axis: new §IV.10, reframed conclusion and recommendations. Identical figures, tables and numbers otherwise. -->
...
> ## ⚠️ Citation warning — the claim of "no public rental" in §IV.10-(3)(4) of this version (v8) is contradicted by measurement
>
> **Verification, 2026-07-31**: This version took as its population only the 29 complexes listed in the NAVER Real Estate metadata and stated that **"direct LH public-rental supply in Godeok is zero."** That **mistook a gap in the data source for a fact.**
>
> - MOLIT lease transactions (2024–, 10,190 records in Godeok) plainly contain public rental complexes: **Pyeongtaek Godeok Gyeonggi Happy Housing** (1,316 records), **Godeok LH Complex 2** (1,106), **Godeok LH Complex 12 (A57-1)** (658), **Godeok LH Complex 17** (351) and **Godeok LH Complex 35** (29). The five explicitly named complexes alone account for **34.0%** of transactions, rising to **49.3%** including three numbered complexes of probable public origin.
> - None of these appears in the complex metadata at all (a nationwide search returns zero for "Gyeonggi Happy Housing"), so they were structurally excluded from this version's 29-complex tally.
> - Accordingly, **do not cite** the 9.4% rental figure in §IV.10-(3), the "zero LH/public direct supply" row of Table 13, the statement in §IV.10-(4) that "neither ownership nor public rental is open," or the related recommendations in §V.3.
>
> **A more consequential derived error — the 0.29M KRW small-unit rent in Table 12**: that figure is not a private-market rent but a **blended median in which public rental accounts for 81% of observations**. Separated, it is 0.27M (public, named) and 0.21M (public, probable) against **0.89M KRW for private units**, i.e. **30/21/18% of monthly income** for private small units — at the edge of the affordability line. The claim that "renting a small unit is affordable (6–10%)" holds **only for public rental**.
>
> **What remains valid**: the entire ownership barrier (Table 11 — median standard-size price 580M KRW; **PIR 16.1/11.6/9.7**; mortgage burden **65/47/39%**) rests on sale transactions and is unaffected. The supply composition (78.4% three-bedroom; 55.3% in the 84–85㎡ group), the gap index (§IV.4), the local character of monthly-rent concentration (73.4% vs. 53.5% in Anseong), and the annual roadmap (§IV.9) are likewise unaffected.
>
> **Direction of correction (planned v9)**: recast from "exclusion through the absence of alternatives" to **"the private market supplies no affordable small units (0.89M KRW), and affordable housing is supplied only through public rental (0.21–0.27M KRW)."** The unit count and eligibility rules of that public rental will be fixed once LH and Pyeongtaek Urban Corporation records are obtained.


*Journal-style manuscript (formatting after *Journal of Korea Planning Association*) — unpublished student research. Korean edition: [`MANUSCRIPT_v8.md`](MANUSCRIPT_v8.md) · Evidence map: [`PAPER_GUIDE.md`](PAPER_GUIDE.md) · Interactive tool: [`design_simulator.html`](design_simulator.html) · Revision history: [`_CHANGELOG.md`](_CHANGELOG.md)*
...
|---|---:|---:|---:|---:|---:|
| Small <60㎡ | 1.14M KRW | 38 / 27 / 23% | **0.29M KRW** | **10 / 7 / 6%** | 5,617 |
| Standard 60–85㎡ | 1.94M KRW | **65 / 47 / 39%** | 1.19M KRW | 40 / 29 / 24% | 1,779 |
| Large ≥85㎡ | 2.37M KRW | 79 / 57 / 47% | 1.26M KRW | 42 / 30 / 25% | 313 |

<sub>Source: MOLIT real transaction prices (2024–2025), authors' calculation. The conventional affordability line is 30% of monthly income.</sub>

Applying the convention that housing costs above 30% of income constitute a cost burden, **ownership of a standard-size unit exceeds the line under all three income scenarios** (39–65%), whereas **renting a small unit stays within it under all three** (6–10%). A gap of this magnitude between ownership and renting is not explicable by preference, and supports explanation (b), **exclusion**. The observed concentration in monthly rent is not the outcome of a taste for mobility but what remains once the ownership path is closed by income constraints.

**(3) The tenure structure of supply — rental exists, public rental does not.** Exclusion becomes a policy problem when those pushed out have no stable alternative. Aggregating the rental-unit field of the complex metadata across **all 29 apartment complexes in Godeok** gives **2,249 rental units out of 23,957 (9.4%)**, held by six complexes (Table 13).

<br>**Table 13. Rental units across all Godeok apartment complexes (29 complexes, 23,957 units)**

| Complex | Approval | Builder | Total units | Rental units | Rental share |
|---|---:|---|---:|---:|---:|
| Eulim Square (private rental) | 2020 | Kumho E&C | 660 | 660 | 100.0% |
| Shindonga Pamilie NHF 7 | 2019 | Shindonga C&E +2 | 719 | 609 | 84.7% |
| Dahaeve | 2024 | Daeheung E&C | 1,167 | 389 | 33.3% |
| Godeok Le Florent | 2021 | Hanshin E&C +2 | 891 | 295 | 33.1% |
| Godeok Hestible | 2023 | Jinheung E&C | 496 | 167 | 33.7% |
| Godeok Yangwoo Naeanae | 2025 | Yangwoo Construction | 385 | 129 | 33.5% |
| Remaining 23 complexes | — | private | 19,639 | 0 | 0.0% |
| **Total** |  |  | **23,957** | **2,249** | **9.4%** |

<sub>Source: NAVER Real Estate complex metadata (`total_households`, `lease_households`), authors' aggregation.</sub>

Three things follow. **First, rental volume exists and is not small.** At 9.4% it is about three times the city-wide figure of 3.35% and roughly five times that of Pyeongtaek outside Godeok (1.97%); **52.1% of all 4,315 rental units in Pyeongtaek sit in Godeok alone.** The statement "Godeok has no rental housing" is therefore false.

**Second, every supplier is nonetheless private.** The six complexes holding rental units were built by Kumho, Shindonga, Daeheung, Hanshin, Jinheung and Yangwoo — all private — and no LH public-rental brand (Andante, Humansia and the like) appears anywhere among the 29. LH, Gyeonggi Housing & Urban Development Corporation and Pyeongtaek Urban Corporation serviced the **land**; they did not build and supply the apartments. Notably, public-sector complexes do exist in Pyeongtaek's older urban core (Gunmun Jugong 1 and 2, Chudam Humansia, Jeongam Tteuranchae), so **the absence of direct public supply is a feature of Godeok New Town rather than of Pyeongtaek as a whole**.

**Third, the character of that rental volume is unverified.** Four complexes show a rental share of almost exactly one third, which hints at a mandatory rental quota attached to land-supply conditions (a publicly supported private rental scheme), but the present data cannot identify the program type, eligibility rules or rent levels. **Whether this 9.4% is in fact open to young or lower-income households, and whether its rents fall below market monthly rent, therefore remains unknown.** Establishing any effect on access would require rent and eligibility data (§V.4-(viii)).

⚠️ **Correction of an earlier draft.** The first draft of this section classified complexes by whether the word "rental" appeared in the complex **name**, and reported 660 rental units, or 3.0%. Most rental volume, however, sits in **mixed for-sale-and-rental complexes** whose names do not disclose it (five of the six), so name-based classification captured under a third of the true figure. The 9.4% obtained from the metadata's rental-unit field is the correct value, and all figures in the text have been revised accordingly. This case — where switching the classification criterion from a nominal label to a measured field changed the magnitude threefold — is added to the self-correction discussion in §V.2.

**(4) A gap in policy design — volume exists, but no designed route.** Setting these facts side by side reveals the position of young households. Supply is standardized into a single template (78.4% three-bedroom; 55.3% in the 84–85㎡ group; §IV.3), and the price of that type exceeds the ownership-entry threshold of entry-level incomes (PIR 16.1; Table 11). Rental volume of 9.4% does exist, but **it is entirely privately supplied, it is unverified whether any of it is designed for young households**, and direct public supply (*haengbok* housing, national rental, permanent rental) appears in none of the 29 complexes. The problem is therefore less an absolute shortage of rental volume than **the absence of a route designed on the premise of the incoming population's age and income structure**. Where rental exists as a by-product of individual projects rather than as an instrument of the plan, who it actually opens to is not controlled.

This is better understood as **a gap in policy design** than as a failure of individual projects. A semiconductor cluster structurally entails a concentrated inflow of young workers, yet the current new-town supply system contains no device for allocating youth-oriented volume, unit types and rent conditions in advance of that inflow. Where the public sector services the land and private builders deliver the housing, **the public sector effectively loses any instrument for shaping unit type, tenure or price point once the land has been supplied.** That Godeok's 9.4% rental volume exists yet cannot be characterized is itself evidence of this loss of control.

**(5) International comparison — institutionalized access instruments.** The United States has institutionalized three layers of instruments for the same problem — housing access for low- and moderate-income households in employment-concentrated areas — and they speak directly to the Godeok structure.

| Instrument | Mechanism | Point of action | Implication for Godeok |
|---|---|---|---|
| **Housing Choice Voucher (Section 8)** | Demand-side subsidy — the household pays roughly 30% of income and the voucher covers the balance up to a payment standard (HUD) | **Tenure stage** | Returns the burden rate of households already pushed into rent to within the affordability line; applicable immediately without new construction |
| **Public Housing** | Publicly owned and operated | **Supply stage** | This layer is not observed in Godeok (zero LH direct supply) |
| **LIHTC (income-restricted housing)** | Tax credits give private developers an incentive to reserve a share of units for income-restricted households for 30 years or more (IRC §42) | **Incentive structure facing private suppliers** | **Best matched to the Godeok structure** — because supply is entirely private, incentive design is more effective than regulation |

Korea already has counterpart instruments on the books (*haengbok* housing, national rental, publicly supported private rental). The problem is not their absence but **the absence of a link that allocates them in advance to a specific site type such as a semiconductor cluster**. What is needed is therefore less the creation of a new instrument than **a coordinating body linking government (land, tax), employers (information on employment scale and age structure) and builders (delivery)**, so that youth-oriented volumes and unit types are **written into the conditions of land supply** at the cluster planning stage. That is the lesson of LIHTC: where private actors deliver all of the supply, the mix does not change without an incentive.

The reason this is not a one-off prescription is that **semiconductor clusters will continue to be built in Korea as a matter of industrial structure**. If subsequent clusters such as Yongin are developed the same way, the same exclusion structure will be reproduced. Godeok is an already-built case, so remedies there center on ex-post instruments (vouchers, acquisition-based rental), whereas later clusters allow **ex-ante allocation at the planning stage**. The gap index and access measures of this study can serve as the basis for that allocation (§V.3).

**(6) Formalizing the exclusion mechanism.** Taken together, exclusion operates in three stages.

> **① Design stage** — supply is standardized into a single three-bedroom, standard-size template (78.4%; 55.3% of units in one 84–85㎡ group; §IV.3).
> **② Price stage** — the price of that standard type (580M KRW; PIR 16.1; mortgage burden 65%) exceeds the ownership-entry threshold of entry-level incomes.
> **③ Tenure-diversion stage** — households excluded from ownership move to the only affordable layer, monthly rent (73.4%). Rental stock of 9.4% exists but is entirely private, direct public supply is zero, and eligibility and rent terms are unverified, so there is **no basis for treating it as a designed route to settlement**. The destination of that move is therefore **short-term monthly rent outside the asset-building ladder**, the layer with the least tenure security.

The implication of this chain is that unit diversification is not a matter of aesthetics or market efficiency but **of who can settle in this city**. Where unit types are uniform, only the income group able to afford that type enters ownership, and the rest are absorbed into insecure tenure without ever being counted as "demand," or leave the area. If the gap in §IV.4 is the language of planning, the access measures in this section are **what that gap becomes once it reaches people**.
...
The consequence of the mismatch did not stop at market statistics. The median standard-size price of 580 million KRW implies a PIR of 16.1 against entry-level income (international burden threshold 5.1) and a mortgage burden of 65% of monthly income, whereas the effective burden of renting a small unit is 10% (§IV.10). **The ownership path is closed and only the rental path is open.** Rental volume of 9.4% does exist, but it is entirely private, direct public supply is zero, and eligibility and rent terms are unverified, so it cannot be regarded as a route **designed** for excluded households. The observed 73.4% monthly rent is thus not natural market segmentation but the end point of an exclusion chain running **design (a single unit type) → price (an entry barrier) → tenure (diversion into the insecure layer)**. What this study diagnoses, therefore, is not an inefficiency in unit composition but **a question of housing access: who is able to settle in this city**.
...
A second self-correction of the same type occurred in the v8 access analysis. Rental volume was first classified by complex **name** and reported as 3.0%, but most rental units sit in mixed complexes whose names do not disclose them, and the true figure is **9.4%** (§IV.10-(3)). The direction of the conclusion (absence of direct public supply) held, but its magnitude changed threefold, and the draft's statement that rental was "virtually absent" had to be withdrawn. The same pattern appeared in geographic identification: logic that selected transactions by whether the complex name contained "Godeok" was **replaced with a legal-dong criterion** (26 false positives, 126 omissions; the small-unit median moved from 354M to 340M KRW). The lesson is **never to use a nominal label as a proxy for a measured field**, and it was confirmed at three independent points during v8 verification.
...
- **Design a housing ladder.** A stepwise path from small-unit monthly rent (6–10% burden) through small and mid-size rental to ownership is not designed into the current supply structure (9.4% rental exists but with unverified eligibility and rent terms; limited small-unit sale stock). Arranging unit types, tenure forms and price points together so that **households can move along the life course within a single city** is a task above adjusting the volume of any individual unit type. It is also the condition for converting in-migrants into settled residents.
